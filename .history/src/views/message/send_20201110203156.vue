...
<div>
    ...
    <div class="card bbxx" style="width: 1000px">
        <div class="chartUser">
            <!-- //send用于管理员给用户发送相关消息 -->
            <el-form :model="sendMsg" status-icon label-width="30px" class="demo-ruleForm" style="padding-right: 30px">
                <!--<div class="helpinfo">
                     内部可以放一些使用指导
                </div> -->
                ...
                <el-form-item style="margin-top: 20px">
                    <label>接收人ID</label>
                    <el-input type="number" ref="receiveid" v-model="sendMsg.receiveid" auto-complete="off" placeholder="例：2020091234"></el-input>
                </el-form-item>

                <el-form-item>
                    <label>消息标题</label>
                    <el-input type="text" ref="msgtitle" v-model="sendMsg.msgtitle" auto-complete="off" placeholder="请输入消息标题"></el-input>
                </el-form-item>

                <el-form-item style="padding-bottom: 30px">
                    <label>消息内容</label>
                    <el-input type="textarea" ref="msgtext" v-model="sendMsg.msgtext" auto-complete="off" placeholder="请输入消息内容……" :rows="12"></el-input>
                </el-form-item>

                <el-form-item style="padding-bottom:30px; padding-right: 30px">
                    <el-button class="subBtn" type="primary" v-on:click="sendMsged">发送</el-button>
                </el-form-item>
...
export default {
    ...
    methods: {
        sendMsged() {
            ...
            if (this.sendMsg.receiveid.length != 10) {
                this.$message({
                    showClose: true,
                    message: "接收人id格式错误！",
                    type: "error"
