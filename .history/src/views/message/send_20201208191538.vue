...
export default {
  ...
  created(){
    ...
    // console.log(this.sendMsg.meetAddr)
  ...
  methods: {
    ...
    console.log(this.sendMsg.userId)     
    send(this.$store.getters.token,this.sendMsg.userId,this.sendMsg.msgtitle,this.sendMsg.msgtext).then((successResponse) => {
