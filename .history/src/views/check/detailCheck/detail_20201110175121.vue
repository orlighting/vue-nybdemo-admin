...
<div class="detailCkeck">
  ...
  <table border="1px" cellspacing="0">
    ...
    <tr align="center">
       <td>以往会展情况</td>
       <td colspan="6" style="font-size: 10px"><div class="down" @click="downPreExpoFile"><img src="../../../assets/file.svg"/>点击下载</div></td> 
    </tr>
    <tr align="center">
       <td>招商方案</td>
       <td colspan="6" style="font-size: 10px"><div class="down" @click="downInvestmentPlanFile"><img src="../../../assets/file.svg"/>点击下载</div></td> 
    </tr>
  </table>
  <br/>
<div class="check">
  <button class="pass" @click="check" v-show='ishow'>审核通过</button>
  <button class="pass" @click="check">列入展会计划</button>
