...
<div class="detailCkeck">
  ...
  <table border="1px" cellspacing="0">
    ...
    <tr align="center">
       <td>参展商来源</td>
       <td >国内{{detailForm.domestic}} 海外{{detailForm.foreign}}</td> 
       <td>观众构成</td>
       <td >参展商<span>{{detailForm.view1}}</span> 消费者<span>{{detailForm.view2}}</span></td>       
    </tr>
    <tr align="center">
       <td>展会内容</td>
    ...
    <tr align="center">
       <td>经费来源</td>
       <td colspan="6">财政资金：<span>{{detailForm.finanFund}}</span>  其他资金<span>{{detailForm.otherFund}}</span> </td> 
    </tr>
    <tr align="center">
       <td>领导出席情况</td>
       <td colspan="6">是否邀请党和国家领导人出席：<span>{{detailForm.leaderD}} </span> 是否邀请境外部级以上政要出席：<span>{{detailForm.leaderF}}</span></td> 
    </tr>
    <tr align="center">
       <td>参会活动内容简述<span>{{detailForm.declare}}</span></td>
       <td colspan="6"></td> 
    </tr>
  </table>
  <br/>
