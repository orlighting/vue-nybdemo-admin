...
<div class="detailCkeck">
  ...
  <table border="1px" cellspacing="0">
    ...
    <tr align="center">
       <td>以往会展情况</td>
       <td colspan="6" style="font-size: 10px"><div class="down" @click="downFile(`this.detailForm.preExpoFile`)"><img src="../../../assets/file.svg"/>点击下载</div></td> 
    </tr>
    <tr align="center">
       <td>招商方案</td>
       <td colspan="6" style="font-size: 10px"><div class="down" @click="downFile(this.detailForm.investmentPlanFile)"><img src="../../../assets/file.svg"/>点击下载</div></td> 
    </tr>
  </table>
  <br/>
<div class="check">
