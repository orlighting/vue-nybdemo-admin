...
<div class="detailCkeck">
  ...
  <table border="1px" cellspacing="0">
    ...
    <tr align="center">
       ...
       <td>观众构成</td>
       <td >参展商<span>{{getView1}}</span> 消费者<span>{{getView2}}</span></td>       
    </tr>
    <tr align="center">
       <td>展会内容</td>
    ...
    <tr align="center">
       <td>经费来源</td>
       <td colspan="1.5">财政资金：<span>{{detailForm.finanFund}}</span> </td>
       <td colspan="1.5"> 其他资金: <span>{{detailForm.otherFund}}</span> </td> 
    </tr>
    <tr align="center">
       <td>领导出席情况</td>
       <td colspan="6">是否邀请党和国家领导人出席：<span>{{getLeaderD}} </span> 是否邀请境外部级以上政要出席：<span>{{getLeaderF}}</span></td> 
    </tr>
    <tr align="center">
       <td>参会活动内容简述</td>
