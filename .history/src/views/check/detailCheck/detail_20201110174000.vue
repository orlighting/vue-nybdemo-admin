...
<div class="detailCkeck">
  ...
  <table border="1px" cellspacing="0">
    ...
    <tr align="center">
       <td>以往会展情况</td>
       <td colspan="6" style="font-size: 10px"><div class="down" @click="downFile(this.detailForm.preExpoFileId)"><img src="../../../assets/file.svg"/>点击下载</div></td> 
    </tr>
    <tr align="center">
       <td>招商方案</td>
       <td colspan="6" style="font-size: 10px"><div class="down" @click="downFile(this.detailForm.investmentPlanFileId)"><img src="../../../assets/file.svg"/>点击下载</div></td> 
    </tr>
  </table>
  <br/>
<div class="check">
...
export default {
  ...
  methods: {
    ...
    downFile(this.detailForm.investmentPlanFile){
    getdetailFile(this.detailForm.investmentPlanFile).then(res => {
          const blob = new Blob([res]);//处理文档流
          const fileName = '京东冷链.pdf';
